...
const Navbar = () => {
  ...
  return (
    <nav className='w-full'>
        ...
        lg:mr-0 lg:text-2xl lg:w-[500px] z-10`}>
            ...
            <li className='cursor-pointer bg-yellow w-[140px] h-[56px] grid place-content-center rounded-full uppercase font-fraunces text-very-dark-desaturated-blue sm:bg-white sm:w-[100px] sm:h-[40px] hover:bg-yellow lg:w-[150px]'>Contact</li>
        </ul>
